...
USE GLOBAL;     USE NAMESC; USE GEOMC;  USE LOGICC; USE PREC;  USE SURFHE;  USE KINETIC; USE SHADEC; USE EDDY
  ...
  USE OUTPUTHDF5, ONLY: ENDOUTPUTHDF5
  IMPLICIT NONE
...
ENDIF
  ...
  IF (HG_CALC) THEN
    DEALLOCATE(TSR_Hg)
    IF(use_BedHg) DEALLOCATE(TSR_Hg2)
    CALL HgModule_Deallocate  
  END IF
  
IF(HDF) CALL ENDOUTPUTHDF5 
