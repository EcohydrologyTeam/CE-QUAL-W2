...
MODULE RSTART
  ...
  INTEGER                                            :: RSODP,  DLTDP,  TSRDP,  WDODP,  RSO=31
...
MODULE NAMESC
  ...
  CHARACTER(6),      ALLOCATABLE, DIMENSION(:)       :: CUNIT,  CUNIT2, CUNIT3
...
MODULE KINETIC
  USE PREC
  REAL                                               :: PCO2,PCO2ATMPPM   ! SW 8/16/2020          
  REAL(R8)                                           :: O2CH4, O2H2S, O2FE2, O2MN2
  REAL(R8),    ALLOCATABLE, DIMENSION(:)             :: KDO, ANOX         ! ANOX = ratio of anoxic to oxic carbon decomposition rate
  ...
  REAL(R8),    POINTER,           DIMENSION(:,:)     :: Hg0,    HgII,   MeHg  ! HgModule
  ...
  REAL(R8),    POINTER,           DIMENSION(:,:)     :: Hg0SS,  HgIISS, MeHgSS, HgIIdSS 
  ...
  REAL,              ALLOCATABLE, DIMENSION(:,:)     :: DO1,    DO2,    DO3,    DO4,    GAMMA, F_NH3
...
MODULE SELWC
  USE PREC
  REAL(R8),              ALLOCATABLE, DIMENSION(:)    :: VNORM,  QNEW, vsums           ! cb 10/31/22
  REAL,                  ALLOCATABLE, DIMENSION(:)    :: ewd, hswbs, hswts, elstrs, elmvs, estrorder, hloss
  REAL(R8),              ALLOCATABLE, DIMENSION(:,:)  :: QSTR,  QSW, QSTRSAV, QDSW             !SR 12/19/2022
  ...
  REAL(R8),              ALLOCATABLE, DIMENSION(:,:)  :: vnorms, veljs           ! cb 10/31/22
  ...
  INTEGER,               ALLOCATABLE, DIMENSION(:)    :: KTOPS,   KBOTS,   KSTRS
  INTEGER,               ALLOCATABLE, DIMENSION(:)    :: kmvs, jsdn, jsup, jspairup, jspairdn, jsorder                     ! cb 10/31/22
  CHARACTER(8),          ALLOCATABLE, DIMENSION(:)    :: DYNSTRUC
  LOGICAL,               ALLOCATABLE, DIMENSION(:)    :: portup, portdn
  REAL(R8) :: dwz       ! cb 2/24/23
  REAL(R8) :: bwz, thetast, zmax, zshift, vozavg, hport, hovlap
  REAL(R8) :: qsumport, wsels
  REAL(R8) :: qwflow
  INTEGER  :: KSTRshft, kwzlim, jsn
  LOGICAL  :: bbi, tbi, wzconv, wzsconv
END MODULE SELWC
MODULE GDAYC
  REAL                                           :: DAYM,   EQTNEW
...
MODULE SCREENC
  USE PREC
  REAL(R8)                                       :: JDAY,   DLTS1,  JDMIN,  MINDLT, DLTAV,  ELTMJD   !ZZ double precision reduces output differences 
...
Module MAIN
  ...
  INTEGER       :: PHG2L_DER,PHG2S_DER,PMHGL_DER,PMHGS_DER,DHG2_DER,DMHG_DER
  ...
  LOGICAL       :: single_wet_well, DOWNSTREAM_LAYERS      ! SR 12/19/2022   ! cb 8/19/22
  CHARACTER(1)  :: ESC
  CHARACTER(2)  :: DEG
  CHARACTER(3)  :: GDCH
  ...
  CHARACTER(72) :: WDOFN,  RSOFN,  TSRFN, SEGNUM, LINE, SEGNUM2, TSRFN1, TSRFN2
  ...
  LOGICAL       :: ORGC_CALC, HDF
  LOGICAL       :: HG_CALC, use_BedHg           
...
! Allocatable array declarations
  ...
  REAL,          ALLOCATABLE, DIMENSION(:,:)   :: theta_STRT, aport, ploss, aport_coef1, aport_coef2        ! cb 2/28/23  
  ...
  INTEGER,       ALLOCATABLE, DIMENSION(:)     :: TSR_Hg, TSR_Hg2
  ...
  INTEGER,       ALLOCATABLE, DIMENSION(:,:)   :: str_flow_prof_eqn, port_shape_type  ! cb 022823  
  ...
  LOGICAL,       ALLOCATABLE, DIMENSION(:)     :: wdz_multi, wet_well                                                  ! cb 10/29/22   
...
! Data declarations
  ...
  CHARACTER(8),ALLOCATABLE, DIMENSION(:) :: wdz_multi_read, wet_well_read    ! cb 11/12/22 
...
MODULE HDF5MOD 
  USE PREC
  REAL, ALLOCATABLE, DIMENSION(:)             :: DATASET1, TEMPSET1, TEMPSET11
  REAL, ALLOCATABLE, DIMENSION(:,:)           :: DATASET2, TEMPSET2, TEMPSET22, TEMPSETC2, TEMPSETD2, TEMPSETQ, TEMPSETT, TEMPSETC
  REAL, ALLOCATABLE, DIMENSION(:,:,:)         :: DATASET3, TEMPSET3
  REAL, ALLOCATABLE, DIMENSION(:,:,:,:)       :: DATASET4, TEMPSET4
  CHARACTER(99), ALLOCATABLE, DIMENSION(:)    :: STRING1, STRING11, STRING12, STRING13, STRING111, STRING1111
  CHARACTER(99), ALLOCATABLE, DIMENSION(:,:)  :: STRING2
  CHARACTER(3),  ALLOCATABLE, DIMENSION(:,:)  :: STRING22, DATAS2
  CHARACTER(99), ALLOCATABLE, DIMENSION(:,:,:):: STRING3
  CHARACTER(3),  ALLOCATABLE, DIMENSION(:)    :: CHARFROMKKK, CHARFROMKSEG 
  CHARACTER(199), DIMENSION(1)                :: STRING0, STRING00
  CHARACTER(10),  DIMENSION(499)              :: CHARFROMKK
  CHARACTER(2),   DIMENSION(99)               :: HDF5_JWBS   
  CHARACTER(10)   :: CHARFROMH, CHARFROMI, CHARFROMJ, CHARFROMK
  CHARACTER(3)    :: CHARFROMSEG1, CHARFROMSEG2
  CHARACTER(4)    :: CHARFROMWD
  CHARACTER(99)   :: HDF5_C, CHARFROMII
  CHARACTER(19)   :: CHAR0, CHAR1
  !
  LOGICAL, TARGET :: dataset_status4, dataset_status4_2a, dataset_status4_4a, dataset_status4_4b, dataset_status4_4c,    &                    
                     dataset_status4_4d,   dataset_status4_1_4a, dataset_status4_1_4b,                                   &
                     dataset_status4_1_8a, dataset_status4_1_9_2_1, dataset_status4_1_9_2_2, dataset_status4_1_9_2_3,    &       
                     dataset_status4_1_10a, dataset_status4_1_10b, dataset_status4_1_10c, dataset_status4_1_10d                          
  LOGICAL, DIMENSION(99), TARGET  :: dataset_status4_1_2, dataset_status4_1_3_1s, dataset_status4_1_3_1ts,               &
                                     dataset_status4_1_3_1cs, dataset_status4_1_3_1ds, dataset_status4_1_3_2_1q,         &
                                     dataset_status4_1_3_2_2t, dataset_status4_1_3_2_3c, dataset_status4_1_3_2_3d,       &
                                     dataset_status4_1_5a, dataset_status4_1_5b, dataset_status4_1_6,                    &
                                     dataset_status4_1_7a, dataset_status4_1_7b, dataset_status4_7a, dataset_status4_7b, &
                                     dataset_status4_1_8, dataset_status4_1_9_1   
  LOGICAL, DIMENSION(999), TARGET :: dataset_status4_1_5_2
  !
  INTEGER, DIMENSION(2)                :: INTS0
  INTEGER, ALLOCATABLE, DIMENSION(:)   :: HDF5_NTR, HDF5_A, HDF5_MSEG, HDF5_WBNSEG, HDF5_JTS, HDF5_NBR, HDF5_NBRST
  INTEGER, ALLOCATABLE, DIMENSION(:)   :: INTS, INTS1, INTS2, INTS3, INTS11, INTS12, INTS13, SEGMTFN, LAYRFN
  INTEGER, ALLOCATABLE, DIMENSION(:)   :: INTS4, INTS5, INTS6, INTS7, INTS8
  INTEGER, ALLOCATABLE, DIMENSION(:,:) :: INTS22, HDF5_KKSEG 
  INTEGER :: HDF5_T, HDF5_E, HDF5_NST, HDF5_K, HDF5_I, HDF5_J, HDF5_NSEG, HDF5_KSEG, HDF5_N, HDF5_M, HDF5_JWB, &
             HDF5_NN, HDF5_ITS, HDF5_JWD, HDF5_JFILE, HDF5_NACD 
  INTEGER :: ALLOCATENO, TRIBUTFN0, KKK, BRANCHFN0, TSRFN0, SEG_TEMP       
  DATA TRIBUTFN0 /3800/, BRANCHFN0 /4000/, TSRFN0 /4100/
END MODULE HDF5MOD  