...
USE GLOBAL;     USE NAMESC; USE GEOMC;  USE LOGICC; USE PREC;  USE SURFHE;  USE KINETIC; USE SHADEC; USE EDDY
  ...
  Use CEMAVars
  USE OUTPUTHDF5, ONLY: HDF5_BALANCES1, HDF5_BALANCES2
  IMPLICIT NONE
    ...
    TPPLANT=0.0
      ...
      KT = KTWB(JW)
        ...
        !NXFLOWBAL = NXFLOWBAL+FLOWBALF  
            ...
            IF(HDF) CALL HDF5_BALANCES1(JW, VOLINJW, VOLPRJW, VOLOUTJW, VOLWDJW, VOLEVJW, VOLDTJW, VOLTRBJW, VOLICEJW, FLOWBFN, JDAY)
...
! END MACROPHYTES
        ...
        IF(JDAY.GE.NXNPBAL)THEN
            ...
            IF(HDF) CALL HDF5_BALANCES2(JW, TPWB, TPSED, TPPLANT, TNWB, TNSED, TNPLANT, MASSBFN)
