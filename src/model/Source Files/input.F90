...
! Title and array dimensions
  ...
  READ (CON,'(//8X,I8,8A8,f8.0,a8)')  NOD,SELECTC,HABTATC,ENVIRPC,AERATEC,inituwl,ORGCC,SED_DIAG,DZMAX,HGMOD
  ELSE
  READ (CON,*)
  READ (CON,*)
  READ (CON,*)
  ...
  READ (CON,*)
  READ (CON,*)
  READ (CON,*) NOD,SELECTC,HABTATC,ENVIRPC,AERATEC,INITUWL,ORGCC,SED_DIAG,DZMAX,HGMOD
  SELECTC=ADJUSTR(SELECTC);HABTATC=ADJUSTR(HABTATC);ENVIRPC=ADJUSTR(ENVIRPC);AERATEC=ADJUSTR(AERATEC);INITUWL=ADJUSTR(INITUWL)
  ORGCC = ADJUSTR(ORGCC); SED_DIAG=ADJUSTR(SED_DIAG); HGMOD=ADJUSTR(HgMOD)
  ENDIF
